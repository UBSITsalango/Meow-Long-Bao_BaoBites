...
<html>
<head>
    <title>Favorites - BaoBites</title>
...
<div class="container mt-4">
    ...
    <div id="favEmpty" class="text-center mt-5 d-none">
        <img src="../assets/images/empty.png" alt="No favorites" style="width:140px; opacity:0.8;">
        ...
        <div class="col-md-4 col-sm-6 fav-card">
            <div class="card shadow-sm recipe-card" style="border-radius:18px; overflow:hidden;">
                ...
                <div class="card-body">
                    ...
                    <span class="badge" style="background:#E2725B;">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="favorite-heart active toggleFav"
                              ...
                              style="cursor:pointer; font-size:1.5rem; color:#E2725B;">
                              ♥
                        </span>
                    </div>
