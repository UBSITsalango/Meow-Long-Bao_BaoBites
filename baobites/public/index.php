...
<section class="py-5 baobites-hero">
  <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between py-5">
      ...
      <div class="text-center text-md-start">
          ...
          <p class="lead mb-4" style="color:#555; max-width:400px;">Discover, share, and savor delicious recipes from our community</p>

          <a href="register.php" class="btn me-2 orange-btn" style="border-radius:25px; padding:10px 20px;">
              Join Our Community
          </a>

          <a href="#featured" class="btn" 
             style="border:2px solid #E2725B; color:#E2725B; border-radius:25px; padding:10px 20px;">
             Explore Recipes
          </a>
      </div>

      <div class="d-none d-md-block">
          <img src="../assets/images/cookie.png" alt="Decor" style="height:180px; opacity:0.9;">
      </div>

  </div>
</section>

<section id="featured" class="py-5 bb-white">
  <div class="container">
...
<section class="py-5" style="background:#A3B18A; color:white;">
  <div class="container text-center">
      <h2 class="fw-bold mb-4">Join Our Cooking Community</h2>
      <p class="mb-5" style="color:#f1f1f1;">Share your favorite recipes and discover new culinary adventures</p>
